  ...
  return (
    <li>
      ...
      <label
        //tabIndex={0}
        htmlFor={id}
        className="cursor-pointer text-center rounded outline-none outline-0 border text-gray-dark-1000 hover:text-gray-dark-1200 bg-transparent hover:bg-gray-dark-600 border-gray-dark-700 hover:border-gray-dark-900 shadow-sm text-xs px-2.5 py-1 peer-checked:text-gray-dark-1200 peer-checked:bg-gray-dark-500 peer-checked:hover:bg-gray-dark-600 peer-checked:hover:border-gray-dark-800">
        {fullName}
      </label>
    </li>
  );
